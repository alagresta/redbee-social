...
twitterUtils.tweetsByTag= function(atag,maxID,callback)
{

	var oEmbedTweets = [];
	var tweets = [];
	var q= this.getUserOrTagQuery(atag);
	var params =  { 'q':q , 'count': TWEET_COUNT , 'max_id':maxID };
...
//exportar para tenerlo disponible en la zona de rutas
